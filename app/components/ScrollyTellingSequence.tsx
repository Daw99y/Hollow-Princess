...
export default function ScrollyTellingSequence() {
  ...
  const phrases =
    language === 'KOR'
      ? [
          <>
            순간을 <span className="font-gothic font-normal">꿰뚫다</span>.
          </>,
          <>
            차가운 <span className="font-gothic font-normal">강철</span>.
          </>,
          <>
            <span className="font-gothic font-normal">따뜻한</span> 피부.
          </>,
          <>
            <span className="font-gothic font-normal">끝없는</span> 수집.
          </>,
        ]
      : [
          <>
            <span className="font-gothic font-normal">Pierce</span> the moment.
          </>,
          <>
            Cold <span className="font-gothic font-normal">steel</span>.
          </>,
          <>
            <span className="font-gothic font-normal">Warm</span> skin.
          </>,
          <>
            <span className="font-gothic font-normal">Endless</span> collection.
          </>,
        ];
